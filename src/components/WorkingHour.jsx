...
const WorkingHour = () => {
  return (
    <div className="flex justify-between gap-30 mx-5 py-8">
        <div className="w-[50%] border rounded-2xl"></div>
      <div className="w-[50%]">
        ...
        <div className="flex flex-col gap-1">
            <div className="flex justify-between items-center h-20 border-b border-b-gray-300">
